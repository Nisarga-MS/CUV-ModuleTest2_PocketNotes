...
export default function GroupNames({groupName,bgColour,fontColor="#000000"}) {
   ...
   const GroupNameTrim =groupNameSplit[0].charAt(0).toUpperCase() + (groupNameSplit[1]? groupNameSplit[1].charAt(0).toUpperCase():"");

  return (
    <div className={styles.groupName}>
        <div className={styles.groupNameTrim} style={{backgroundColor:bgColour}}>
            {GroupNameTrim}
        </div>
